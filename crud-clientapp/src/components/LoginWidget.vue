...
<div>
    ...
    <b-modal id="login-modal" title="LOGIN" header-bg-variant="primary" static lazy hide-footer no-stacking no-close-on-esc no-close-on-backdrop>
...
export default {
  ...
  mounted: function () {
    ...
    this.$root.$on('bv::modal::shown', (bvEvent, modalId) => {
        var sigInEl = document.getElementById('okta-signin-container');
